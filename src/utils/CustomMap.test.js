...
describe('Basic usage tests', () => {
  ...
  beforeEach(() => {
    ...
    map2 = new CustomMap([['apple','granny smith'],['banana','cavendish'],['kiwifruit','golden']]);
...
describe('Hash function tests', () => {
  ...
  test('Normal functionality', () => {
    ...
    let map2 = new CustomMap(map1);
    expect([...map2]).toEqual([...map1]);
    let map3 = new CustomMap(map1, String);
...
describe('Equal function tests', () => {
  ...
  test('Normal functionality', () => {
    ...
    expect([...map1.values()]).toEqual(expect.arrayContaining(['50 number NEW','cincuenta y cuatro']));
    let map2 = new CustomMap(map1);
    expect([...map2]).toEqual([...map1]);
    let map3 = new CustomMap(map1, String, typeEqual);
    expect([...map3]).toEqual([...map1]);
  });
  test('Hash collisions', () => {
    map1.set(50,'110010');
    ...
    let map2 = new CustomMap(map1, String);
