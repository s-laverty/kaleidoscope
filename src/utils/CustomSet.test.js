...
describe('Hash function tests', () => {
  ...
  test('Normal functionality', () => {
    ...
    let set2 = new CustomSet(set1);
    expect([...set2]).toEqual([...set1]);
    let set3 = new CustomSet(set1, String);
...
describe('Equal function tests', () => {
  ...
  test('Normal functionality', () => {
    ...
    let set2 = new CustomSet(set1);
    expect([...set2]).toEqual([...set1]);
    let set3 = new CustomSet(set1, String, typeEqual);
    expect([...set3]).toEqual([...set1]);
  });
  test('Hash collisions', () => {
    set1.add(50);
    ...
    let set2 = new CustomSet(set1, String);
